...
app.get('/api/templates/:type', (req, res) => {
  ...
  const templates = {
    vcard: [
      { 이름: '홍길동', 전화번호: '010-1234-5678', 이메일: '', 회사: '', 직책: '', 주소: '', 메모: '강원대특강', 접미사: '2026년 강원대 1월 특강' },
      { 이름: '김철수', 전화번호: '010-9876-5432', 이메일: 'kim@example.com', 회사: '(주)회사', 직책: '대리', 주소: '', 메모: '', 접미사: '' },
      { 이름: '이영희', 전화번호: '010-5555-1234', 이메일: '', 회사: '', 직책: '', 주소: '', 메모: '친구', 접미사: '' }
    ],
    wifi: [
